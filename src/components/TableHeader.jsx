    ...
    return (
        <div className="border border-black text-sm">
            ...
            <div className="grid grid-cols-12 border-b border-black">
                ...
                <div className="col-span-2 border-r border-black p-1 text-blue-700 font-medium text-center">{dateOfIssue}</div>
                <div className="col-span-4 border-0 border-black p-1 text-left">Engineering Div. Approval</div>
                <div className="col-span-2 p-1 text-blue-700 font-medium text-center">{approvalDate}</div>
            </div>
