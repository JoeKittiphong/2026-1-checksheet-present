        ...
        <div className="border border-black text-sm mb-4">
            ...
            <div className="flex border-b border-black">
                ...
                <div className="w-1/3 border-r border-black flex flex-col">
                    ...
                    <div className="flex-1 flex items-center justify-center border-b-0 border-black">
                        {subtitle}
                    </div>
                ...
                <div className="w-1/3">
                    ...
                    <div className="flex border-b-0 border-black">
                        <div className="w-1/3 p-1 pl-2 border-r-0 border-black">Date</div>
                        <div className="w-2/3 p-1 text-center font-medium">{date}</div>
                    </div>
